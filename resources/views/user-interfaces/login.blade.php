    ...
    <div class="login-details">
        <div class="login-card">
            ...
            <form>
                ...
                <input type="text" name="e-title-keywords" id="e-title-box" />
            </form>
            <form>
                <label for="ntext"> الرقم السري</label>
                <input type="text" name="n-title-keywords" id="n-title-box" />
            </form>

            <form>
                <input type="checkbox" id="save" name="save" value="" />
                <label style="display: inline" for="save"> حفظ البيانات</label>
            </form>
