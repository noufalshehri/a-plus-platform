...
<div class="container">
    ...
    <div class="classification">
        ...
        <div>
            <input type="radio" id="qus" name="question-radio" value="" />
              <label for="qus">سؤال</label><br />
        </div>

        <div>
            <input type="radio" id="cont" name="question-radio" value="" />
    ...
    <div class="question-details-parent">
        <div class="question-details">
            <form class="q_title">
                ...
                <input type="text" name="q-title-keywords" id="q-title-box" />
            </form>
